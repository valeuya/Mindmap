...
//сообщает фреймворку, с какими узлами св€зано соединение.
	@Override
	protected void doAttachToAnchorageVisual(IVisualPart<? extends Node> anchorage, String role) {
		// найти провайдерa  прив€зки, который должен быть зарегистрирован в модуле
		// помнить об использовании правильных интерфейсов (часто используетс€
		// провайдер)
